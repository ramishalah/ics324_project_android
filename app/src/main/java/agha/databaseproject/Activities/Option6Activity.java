...
import ListViewAdapters.Option6Adapter;
...
public class Option6Activity extends AppCompatActivity {
    ...
    @BindView(R.id.option6_spinner)
    AppCompatSpinner spinner;

    @BindView(R.id.option6_lv)
    ListView lv ;

    @BindView(R.id.option6_search)
    FloatingActionButton button ;

    private String URL = "https://ics324-project-server-side.herokuapp.com/instructors/";
    private Option6Adapter adapter;
            ...
            public void onClick(View view) {
                ...
                StringRequest stringRequest = new StringRequest(Request.Method.GET, newURL, new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        List<Option6> list = Arrays.asList(gson.fromJson(response, Option6[].class));

                        adapter = new Option6Adapter(getApplicationContext(),list);
